...
export type RunAutomationButtonProps = { automation: Automation; labelled?: boolean };

export function RunAutomationButton({ automation, labelled = false }: RunAutomationButtonProps) {
  ...
  const confirm = async () => {
    try {
      ...
      toast.success(t("runQueued", { title: automation.title }));
    } catch (error) {
