import automationCatalogue from "./automation-catalogue.json";
import automationQueued from "./automation-queued.json";
import automationRuns from "./automation-runs.json";
